...
ptData.mainStatText !== 'Elemental Mastery'
  ...
  : Math.round(folderData[level2].specialized)
                        ...
                        <Image width={215} height={215} src={id != ptData.name3 ? `https://gi.yatta.moe/assets/UI/${ptData.images.filename_icon}.png` : `https://gi.yatta.moe/assets/UI/${ptData.images.filename_icon}.png`
